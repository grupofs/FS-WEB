...
<body class="boxed_wrapper" íd="CuerpoWeb">
    ...
    <section class="destin-details ServiciosFSclass unique_page" id="DiseñoSanitarioPlantaAlmacenes" style="background-image: url(images/fancybox/blank.gif);">
        <div class="container"> 
            ...
            <div class="row items-container clearfix bg_servicios" style="padding:24px">
                <div class="col-lg-6 col-md-12 text-left">
                    <div class="titulo_servi1 titulo_principal text-left"><?php echo $titulo_servicioDisenoSanitarioPlantaAlmacenes; ?></div>
                    <img src="./images/FS/serv3_1.jpg?v=3" class="servicios_detalle" style="max-width:100%">
                </div>
                <div class="col-lg-6 col-md-12 text-left lista_p_servic" style="position:relative">
                    <p class="parrafo_serv">
                        <?php echo $servicio_DisenoSanitarioPlantaAlmacenes; ?>
                ...
                <div class="col-lg-12 col-md-12 text-center" style="margin-bottom:30px">
                    <div class="row cuadros_prog cuad5">
                        <?php echo $servicio_DisenoSanitarioPlantaAlmacenes_1; ?>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 text-left">
                <div class="titulo_servi1"><?php echo $valor_agregado; ?></div>
                    <table class="tabla_serv_icons">
                        <?php echo $servicio_DisenoSanitarioPlantaAlmacenes_2; ?>
                    </table>
                </div>
                <div class="col-lg-6 col-md-12 text-left">
                <div class="titulo_servi1"><?php echo $producto_servicio; ?></div>
                    <table class="tabla_serv_icons">
                        <?php echo $servicio_DisenoSanitarioPlantaAlmacenes_3; ?>
                    </table>
                </div>
            </div>
        </div>
