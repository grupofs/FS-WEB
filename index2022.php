        ...
        <div class="container-fluid">
            <ul class="main-slider-carousel owl-carousel owl-theme slide-nav">
                <li class="slider-wrapper">
                    <div class="image"><img src="images/FS/socio-estrategicos-fs.jpg" alt="Validación térmica alimentos" ></div>
                ...
                <li class="slider-wrapper">
                    <div class="image "><img src="images/FS/socio-estrategicos-fs-2.jpg" alt="Estudio f0 conservas"></div>
                    <div class="slider-caption">
                        <div class="container">
                ...
                <li class="slider-wrapper">
                    <div class="image "><img src="images/FS/socio-estrategicos-fs-3.png" alt="Somos tu socio estrategicos - Grupo FS"></div>
                    <div class="slider-caption">
                        <div class="container">
                            ...
                            <div id="quienes_somos" class="col-lg-7 col-md-12 col-12 ">
                                <div class="content-box">
                                    ...
                                    <div class="text" style="color: white;">
                                        ...
                                        Con el tiempo diversificamos nuestros servicios en áreas de soporte en asuntos regulatorios, salud y seguridad ocupacional, procesamiento térmico, validación térmica de alimentos, mermas, entre otros; manteniendo como fortaleza nuestro sistema de atención personalizado y permanente con todos nuestros clientes.
                                    </div>
                     ...
                     <div class="row">
                         ...
                         <div class="col-lg-6 col-md-12 col-12">
                            ...
                            <div class="float-right">
                                 <img src="images/FS/Procesos_Termicos-validacion_termica_alimentos.png" alt="" width="240px" height="80px">
                            </div>
                             ...
                             <div class="content-box">
                                 ...
                                 <div class="accordion-box">
                                    <div class="accordion animated out" data-delay="0" data-animation="fadeInUp">
                                        <div class="acc-btn active">
                                            <div class="title"><i class="fa fa-caret-right" style="color: #EE8700;"></i> <strong>Estudios de Validación Térmica</strong></div>
                                            <div class="toggle-icon">
                                                <span class="plus fa fa-plus"></span><span class="minus  fa fa-minus"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="acc-content collapsed">
                                            <p>Penetración de calor (<strong>estudios F0</strong>) y distribución de temperatura en conservas, autoclaves, marmitas, secadores, pasteurizadores, entre otros.Sistemas  de  procesamiento  y  envasado  aséptico;  asi  como, llenado y mantenimiento en caliente/frío.Mapeos térmicos (frío y calor), curvas o Perfiles de temperatura (mapeos térmicos), entre otros.</p>
                                        </div>
